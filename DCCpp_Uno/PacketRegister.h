...
// change value to 12 in order to program Bachmann K4
#define  ACK_SAMPLE_THRESHOLD       12      // the threshold that the exponentially-smoothed analogRead samples (after subtracting the baseline current) must cross to establish ACKNOWLEDGEMENT
